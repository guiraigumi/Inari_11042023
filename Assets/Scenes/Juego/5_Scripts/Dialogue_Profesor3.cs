...
public class Dialogue_Profesor3 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject profesorTalking;
    ...
    private void StartDialogue()
    {
        ...
        profesorTalking.SetActive(true);
        lineIndex = 0;
    ...
    private void NextDialogueLine()
    {
        ...
        else
        {
            ...
            profesorTalking.SetActive(false);
